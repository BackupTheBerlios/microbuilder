<?php // $Id: index.php,v 1.1 2004/03/01 10:09:00 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
function viewarticle()
{
    ...
    echo "<font class=\"pn-normal\">(".pnVarPrepForDisplay($words)." "._TOTALWORDS.")</font><br />"
        ...
        ."<font class=\"pn-normal\"><a class=\"pn-normal\" href=\"modules.php?op=modload&amp;name=$GLOBALS[ModName]&amp;file=index&amp;req=printpage&amp;artid=$artid\"><img src=\"modules/".pnVarPrepForOS($GLOBALS['name'])."/images/print.gif\" border=\"0\" Alt=\""._PRINTER."\"></a>"
        ."</font><br /><br />";
    ...
    echo pnModCallHooks('item', 'display', $artid, "modules.php?op=modload&name=Sections&file=index&req=viewarticle&artid=$artid&page=$page");
    include ('footer.php');
}
...
function PrintSecPage()
{
    ...
    echo "</head>"
        ...
        ."<table border=\"0\" cellpadding=\"20\" cellspacing=\"1\" bgcolor=\"#FFFFFF\"><tr><td>"
        ."<center>"
        ."<img src=\"images/$site_logo\" border=\"0\" alt=\"\"><br /><br />"
        ."<b>".pnVarPrepForDisplay($title)."</b><br /><br />"
        ."</center>"
        ."".pnVarPrepHTMLDisplay($content)."<br /><br />";
