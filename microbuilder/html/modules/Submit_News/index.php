...
// ML added global and dropdown with available languages
   ...
   // global $ModName, $topic, $sel;
    ...
    echo "<br /><br /><b>"._ARTICLETEXT."</b> "
        ."("._HTMLISFINE.")<br />"
        ."<textarea class=\"pn-normal\" cols=\"80\" rows=\"10\" name=\"storytext\"></textarea> "._REQUIRED."<br />"
        ."<br /><b>"._EXTENDEDTEXT."</b>"
        ."<br /><textarea class=\"pn-normal\" cols=\"80\" rows=\"10\" name=\"bodytext\"></textarea><br />";
...
function PreviewStory()
{
  ...
  //  global $bgcolor1, $bgcolor2, $ModName;
    ...
    if($subject == '' || $storytext == '') {
        ...
        echo "<center><font class=\"pn-normal\">"._GOBACK."</font></center><br /><br />";
        CloseTable2();
        include("footer.php");
        exit;
    }
    ...
    echo "<center>"
    ."<font class=\"pn-title\">".pnVarPrepHTMLDisplay($warning)."</font>"
    ."</center>"
    ...
    echo"<br /><br /><b>"._ARTICLETEXT."</b> "
        ."("._HTMLISFINE.")<br />"
        ."<textarea cols=\"80\" rows=\"10\" name=\"storytext\">" . pnVarPrepHTMLDisplay($storytext) . "</textarea> "._REQUIRED."<br />"
        ."<br /><b>"._EXTENDEDTEXT."</b>"
        ."<br /><textarea cols=\"80\" rows=\"10\" name=\"bodytext\">" . pnVarPrepHTMLDisplay($bodytext) . "</textarea><br />"
