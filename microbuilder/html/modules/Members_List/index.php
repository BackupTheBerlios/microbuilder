<?php 
// $Id: index.php,v 1.1 2004/03/01 10:09:00 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
"._ONLINE."</center>";
	...
	if ($get=='online') {
echo"<a name=\"online\"></a>";	
echo"<br><table align=\"center\" width=\"95%\" cellspacing=\"1\" cellpadding=\"5\" bgcolor=\"".$GLOBALS['bgcolor2']."\"><tr><td bgcolor=\"".$GLOBALS['bgcolor1']."\">";
		foreach ($unames as $uname) {
			//$myquery = buildSimpleQuery('users', array('uid', 'name', 'uname', 'femail', 'url'), 'pn_uname =$uname');
			//$result = $dbconn->Execute($myquery);
			// $dcolor = ($a == 0 ? $dcolor_A : $dcolor_B);
			echo "<font class=\"pn-normal\"><b>+ ".pnVarPrepForDisplay($uname)."&nbsp;</b></font> ";
...
echo "\n\n<!-- MEMBERS LIST -->\n\n";
        echo"<a name=\"top\"></a>";
        echo "<center><img src=\"modules/$GLOBALS[ModName]/images/logo.gif\" border=\"0\" alt=\"\"></center><br>\n";
        ...
        if(pnSecAuthAction(0, 'Users::', '::', ACCESS_COMMENT)){
            ...
            echo "<center><font class=\"pn-normal\">[ <b>"._NAVREG.": </b>".pnVarPrepForDisplay($numrows)." | <b>"._NAVONLINE.": </b>";
                        getnumber('countnum');
                         echo" |\n";
...
// This starts the beef...
 ...
 $sort = "$sortby ASC"; //sorty by .....
        ...
        if ($letter != "front") {
            echo "<table width=\"95%\" align=\"center\"><tr><td align=right>|<a href=\"#last\">"._LAST10REG."</a>| <a href=\"#online\">"._CURRENTONLINE."</a> |</td></tr></table><table width=\"95%\" border=\"0\" cellpadding=\"3\" cellspacing=\"1\" bgcolor=\"".$GLOBALS['bgcolor2']."\" align=center><tr bgcolor=\"".$GLOBALS['bgcolor2']."\">\n";
...
src=\"modules/$GLOBALS[ModName]/images/online.gif\"  align=\"middle\" border=\"0\" alt=\"\">"._STATUSONLINE."</b></font>";
    }
    else
    {
    $check = "<font color=black><img
src=\"modules/$GLOBALS[ModName]/images/offline.gif\" align=\"middle\" border=\"0\" alt=\"\">"._STATUSOFFLINE."</font>";
    }
                    $dcolor = ($a == 0 ? $dcolor_A : $dcolor_B);
                    echo "<tr><td align=\"center\" width=\"10\" bgcolor=\"$dcolor\">$check</td><td  width=\"40\" bgcolor=\"$dcolor\" align=\"center\">";
if($user['user_avatar']!=''){
echo"<img  width=\"40\" src=\"images/avatar/".pnVarPrepForDisplay($user['user_avatar'])."\" border=\"0\" alt=\"\">";
}
echo"</td><td bgcolor=\"$dcolor\">&nbsp;&nbsp;<a class=\"pn-normal\" href=\"user.php?op=userinfo&amp;uname=$user[uname]\"><b>".pnVarPrepForDisplay($user['uname'])."</b></a>";
                                        if($user['user_icq'] >0) {
                echo "<img align=\"middle\" src=\"http://wwp.icq.com/scripts/online.dll?icq=".pnVarPrepForDisplay($user['user_icq'])."&amp;img=5\" border=\"0\">";
        }
                                        echo"&nbsp;</td>\n";
                    echo "<td bgcolor=\"$dcolor\">&nbsp;&nbsp;<font class=\"pn-normal\">".pnVarPrepForDisplay($user['name'])."&nbsp;</font></td>\n";
                    echo "<td bgcolor=\"$dcolor\" align=\"center\"><b><font class=\"pn-normal\">";
                                         if (pnUserLoggedIn()) {
                                        echo"<a href=\"modules.php?op=modload&amp;name=Messages&amp;file=replypmsg&amp;send=1&amp;uname=".pnVarPrepForDisplay($user['uname'])."\"><img src=\"modules/$GLOBALS[ModName]/images/mail.gif\" alt=\"\" border=\"0\"></a>";
}
else
{
echo"<a href=\"user.php\"><img src=\"modules/$GLOBALS[ModName]/images/mail.gif\" border=\"0\" alt=\"\"></a>";
}
...
echo"</font></b></td>\n";
                ...
                if(!$user['url'] or $user['url']=="http://" or $user['url']=="http:///" )  {
                        ...
                        $img ='';
                                ...
                                {
                                $url = $user['url'] ;
                                $img ="<img src=\"modules/".$GLOBALS['ModName']."/images/url.gif\" border=\"0\" alt=\"\">";
                                }
            ...
            echo "<a href=\"$url\" target=\"new\">$img</a>&nbsp;</td>\n";
                ...
                echo "\n<tr><td colspan=\"9\" bgcolor=\"".$GLOBALS['bgcolor2']."\">";
                                getnumber('number');
                                echo"</td></tr><tr bgcolor=\"".$GLOBALS['bgcolor2']."\"><td colspan=\"8\" bgcolor=\"".$GLOBALS['bgcolor2']."\">";
                                getnumber('online');
                                echo"<br></td></tr></table><br><table width=\"95%\"><tr><td bgcolor=\"".$GLOBALS['bgcolor1']."\" colspan='7' align='right'>\n";
                ...
                if ($numrows > $pagesize) {
                    ...
                    if ( $prev_page > 0 ) {
                        echo "<td align='left' width='15%'><a class=\"pn-normal\" href='modules.php?op=modload&amp;name=$GLOBALS[ModName]&amp;file=index&amp;letter=".pnVarPrepForDisplay($letter)."&amp;sortby=$sortby&amp;page=$prev_page'>";
                    ...
                    if ( $next_page <= $total_pages ) {
                        ...
                        echo "<tr><td colspan=\"3\"></td><tr><tr><td colspan=\"3\" align=\"center\">";
...
echo"<a name=\"last\"></a>";
echo"<table width=\"95%\" bgcolor=\"".$GLOBALS['bgcolor2']."\" cellspacing=\"1\" cellpadding=\"3\" align=\"center\"><tr bgcolor=\"".$GLOBALS['bgcolor2']."\"><td colspan=\"6\"><b><u>"._LAST10REG.":</u></b></td></tr>";
...
$check</td><td bgcolor=\"$dcolor\"><a class=\"pn-normal\" href=\"user.php?op=userinfo&amp;uname=".pnVarPrepForDisplay($user['uname'])."\"><b>".pnVarPrepForDisplay($user['uname'])."</b></a></td><td bgcolor=\"$dcolor\">".date('d.m.Y',$user_regdate)."</td>\n";
                    echo "<td bgcolor=\"$dcolor\">&nbsp;&nbsp;<b><font class=\"pn-normal\">".pnVarPrepForDisplay($user['name'])."&nbsp;</font></b></td>\n";
...
if(!$user['url'] or $user['url']=="http://" or $user['url']=="http:///")  {
 ...
 echo "<td bgcolor=\"$dcolor\" width=\"18\" align=\"center\"><a href=\"modules.php?op=modload&amp;name=Messages&amp;file=replypmsg&amp;send=1&amp;uname=".pnVarPrepForDisplay($user['uname'])."\"><img src=\"modules/$GLOBALS[ModName]/images/mail.gif\" border=\"0\" alt=\"\"></a></td>\n";
