<?php 
// File: $Id: user.php,v 1.1 2004/03/01 10:09:03 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
function user_user_getlogin()
{
    ...
    if ($GLOBALS['stop']) {
        ...
        echo "" . _SELECTOPTION . "<br><br>" . "<a href=\"user.php?op=loginscreen&amp;module=NS-User\">" . _LOGINSITE . "</a><br><br>"; 
        ...
        if (pnConfigGetVar('reg_allowreg')) {
            ...
            echo "<b>" . _NOTALLOWREG . "</b><br>"._REASONS."<br>&nbsp;&nbsp;&nbsp;&nbsp;" . pnVarPrepForDisplay(pnConfigGetVar('reg_noregreasons')) . "<br><br>";
        } 
...
function user_main_last10com($uname)
{
     ...
     */
    OpenTable();
    echo "<font class=\"pn-title\">" . _LAST10COMMENTS . " " . pnVarPrepForDisplay($uname) . ":</font><br><ul>";
