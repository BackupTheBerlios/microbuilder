...
function polls_ModList()
{
    ...
    while(list($pollID, $pollTitle, $timeStamp, $planguage) = $result->fields) {
        ...
        if (pnSecAuthAction(0, 'Polls::', "$pollTitle::$pollID", ACCESS_EDIT)) {
            echo "<li><font class=\"pn-normal\">".pnVarPrepForDisplay($pollTitle)." - (".pnVarPrepForDisplay($planguage).") [ <a href=\"admin.php?module=NS-Polls&amp;op=editPoll&amp;id=$pollID\">"._EDIT."</a> ";
...
function polls_admin_getConfig() {
    ...
    GraphicAdmin();
    OpenTable();
    print '<center><font size="3" class="pn-title"><b>'._POLLSCONF.'</b></font></center><br />'
         .'<form action="admin.php" method="post">'
