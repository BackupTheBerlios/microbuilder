<?php
// File: $Id: admin.php,v 1.1 2004/03/01 10:09:01 mbertier Exp $
// ----------------------------------------------------------------------
...
function viewGroups()
{
   $module = pnVarCleanFromInput('module');
    ...
    // Heading
    OpenTable();
    echo "<CENTER><font class=\"pn-title\"><B>"._GROUPADMIN."</B></FONT><BR>";
    ...
    if (!$result->EOF) {
        echo "<TABLE BORDER=\"5\">".
             "<TR CLASS=\"pn-title\">".
             "<TD><CENTER><font class=\"pn-normal\">"._GROUPNAME."</font></CENTER></TD>".
             "<TD>&nbsp;</TD>".
             "</TR>";
...
function viewGroup()
{
    ...
    echo "<BR>".
         ...
         "<TR>";
    if (pnSecAuthAction(0, 'Groups::', "$gname::$gid", ACCESS_EDIT)) {
        echo "<TD><CENTER><A HREF=\"admin.php?module=".$module."&amp;op=secselectuserforgroup&amp;gid=$gid\"><font class=\"pn-title\">"
        ._ADDUSERTOGROUP."</FONT></A></CENTER></TD>".
         "<TD><CENTER><A HREF=\"admin.php?module=".$module."&amp;op=secmodifygroup&amp;gid=$gid\"><font class=\"pn-title\">"
         ._MODIFYGROUP."</FONT></A></CENTER></TD>";
...
*/
    ...
    if (!$result->EOF) {
        ...
        echo "<CENTER><B><font class=\"pn-normal\">"._USERSINGROUP."</font></B><BR>".
             "<TABLE BORDER=\"1\">".
             "<TR>".
             "<TD><CENTER><font class=\"pn-normal\">"._USERNAME."</font></CENTER></TD>".
             "<TD>&nbsp;</TD>".
             "</TR>";
        ...
        echo "<CENTER><B><font class=\"pn-normal\">"._NOONEINGROUP."</font></B></CENTER>";
    }
...
function newGroup()
{
    ...
    echo "<FORM ACTION=\"admin.php\" METHOD=\"POST\">"
	 ...
	 ."<font class=\"pn-normal\"><INPUT TYPE=\"HIDDEN\" NAME=\"authid\" value=\"" . pnSecGenAuthKey() . "\">"
...
function addGroup()
{
    ...
    if ($count == 1) {
        ...
        OpenTable();
        echo "<CENTER><A HREF=\"admin.php?module=".$module."&amp;op=secviewgroups\" CLASS=\"pn-title\"><FONT SIZE=\"4\"<B>"
        ._GROUPADMIN."</B></FONT></A>:<font class=\"pn-normal\"> ".pnVarPrepForDisplay($gname)."</font></CENTER>";
        echo "<BR>";
...
function selectUserForGroup()
{
    ...
    OpenTable();
    echo "<CENTER><A HREF=\"admin.php?module=".$module."&amp;op=secviewgroups\" CLASS=\"pn-title\"><FONT SIZE=\"4\"<B>"
    ._GROUPADMIN."</B></FONT></A><font class=\"pn-title\"><B><font class=\"pn-normal\">: ".pnVarPrepForDisplay($gname)."</font></B></FONT></CENTER>";
    echo "<BR>";
    ...
    if (!$result->EOF) {
        echo "<BR>"
             ."<FORM ACTION=\"admin.php\" METHOD=\"POST\"><font class=\"pn-normal\">"
             ._USERTOADD.": "
              ."</font><input type=\"hidden\" name=\"module\" value=\"".$module."\">"
...
function deleteUserFromGroup()
{
    ...
    if (!pnSecAuthAction(0, 'Groups::', "$gname::$gid", ACCESS_EDIT)) {
        ...
        OpenTable();
        echo "<CENTER><A HREF=\"admin.php?module=".$module."&amp;op=secviewgroups\" CLASS=\"pn-title\"><FONT SIZE=\"4\"<B>"
        ._GROUPADMIN."</B></FONT></A><font class=\"pn-normal\">: ".pnVarPrepForStore($gname)."</font></CENTER>";
        CloseTable();
        echo _GROUPSEDITNOAUTH;
        include 'footer.php';
        return;
