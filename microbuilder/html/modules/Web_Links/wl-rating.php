<?php
// File: $Id: wl-rating.php,v 1.1 2004/03/01 10:09:02 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
function ratelink($lid, $ttitle) {
    ...
    ."<font class=\"pn-sub\"><input type=\"submit\" value=\""._RATETHISSITE."\"></font>"
        ."<br /><br />";
    if (pnUserLoggedIn()) {
        echo "<font class=\"pn-normal\"><b>"._COMMENT." :</b></font><br /><textarea wrap=\"virtual\" cols=\"80\" rows=\"10\" name=\"ratingcomments\"></textarea>"
            ."<br /><br /><br />"
            ."</font></td>";
    } else {
