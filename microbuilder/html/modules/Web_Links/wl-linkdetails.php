<?php
// File: $Id: wl-linkdetails.php,v 1.1 2004/03/01 10:09:03 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
function viewlinkcomments($lid, $ttitle) {
    ...
    while(list($ratinguser, $rating, $ratingcomments, $ratingtimestamp)=$result->fields) {
        ...
        $useravgrating = number_format($useravgrating, 1);
               ...
               ."<font class=\"pn-normal\"><b> "._USER.": </b>";
                  if (!(pnSecAuthAction(0, 'Web Links::', '::', ACCESS_COMMENT))) {
                           echo pnVarPrepForDisplay($ratinguser);
                   } else {
                   echo "<a class=\"pn-normal\" href=\"" . pnGetBaseURL() . "user.php?op=userinfo&amp;uname=".pnVarPrepForDisplay($ratinguser)."\">".pnVarPrepForDisplay($ratinguser)."</a>";
                        }
                        echo "</font>"
           ."</td>"
...
function viewlinkdetails($lid, $ttitle) {
    ...
    echo pnModCallHooks('item', 'display', $lid, "modules.php?op=modload&name=$GLOBALS[ModName]&file=index&req=viewlinkdetails&lid=$lid&ttitle=$ttitle");
...
function outsidelinksetup($lid)
{
    ...
    OpenTable();
   // "._THENUMBER." \"$lid\" "._IDREFER1." $sitename"._IDREFER2."<br /><br />
    echo "<font class=\"pn-normal\"><center><b>"._PROMOTEYOURSITE."</b></center><br /><br />
    ...
    <tr><td align=\"center\"><b>"._VOTE4THISSITE."</b></td></tr>
    <tr><td>
    ...
    if ($blocknow != 1) {
        ...
        while(list($cid, $title, $url, $description) = $result->fields) {
            ...
            echo "<form action=\"".$GLOBALS['modurl']."\" method=\"post\">"
                ...
                .""._DESCRIPTION255.": <br /><textarea name=\"description\" cols=\"80\" rows=\"10\">".pnVarPrepHTMLDisplay($description)."</textarea><br /><br />";
