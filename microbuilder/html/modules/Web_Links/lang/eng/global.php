...
define('_ANONPOSTLINKS','Let Anonymous users post new links?');
...
define('_LINKNOCAT','ERROR: No Category');
define('_LINKSNOCATS','No web link categories available - web links disabled');
...
define('_MOSTPOPLINKS','Most popular: either # of links or percentage to show (percentage as whole number. #/100)');
...
define('_RATENOTE4','You can view a list of the <a href="modules.php?op=modload&amp;name='.$GLOBALS["ModName"].'&amp;file=index&amp;req=TopRated">top rated resources</a>.');
