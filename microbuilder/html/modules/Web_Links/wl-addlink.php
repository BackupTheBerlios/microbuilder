<?php
// File: $Id: wl-addlink.php,v 1.1 2004/03/01 10:09:03 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
function AddLink()
{
    ...
    if (pnSecAuthAction(0, 'Web Links::', "::", ACCESS_COMMENT)) {
        ...
        echo CatList(0, 0);
        echo "</select><br /><br />"
            .""._LDESCRIPTION."<br><textarea name=\"description\" cols=\"80\" rows=\"10\"></textarea><br /><br /><br />"
        ...
        echo "<center><font class=\"pn-normal\">"._LINKSNOTUSER1."<br />"
