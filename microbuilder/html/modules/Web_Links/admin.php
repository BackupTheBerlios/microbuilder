<?php
// File: $Id: admin.php,v 1.1 2004/03/01 10:09:02 mbertier Exp $
// ----------------------------------------------------------------------
...
function LinksListBrokenLinks()
{
    ...
    if ($totalbrokenlinks==0) {
        echo "<tr><td><center><font class=\"pn-title\">"._NOREPORTEDBROKEN."</font></center><br><br><br></td></tr>";
    } else {
...
function LinksLinkCheck()
{
    ...
    echo "<form method=\"post\" action=\"admin.php\"><font class=\"pn-sub\">"
         ."<input type=\"hidden\" name=\"module\" value=\"".$GLOBALS['module']."\">"
         ."<input type=\"hidden\" name=\"op\" value=\"LinksValidate\">"
         ."<input type=\"hidden\" name=\"authid\" value=\"" . pnSecGenAuthKey() . "\">"
         ."<select name=\"cid\">".CatList(0,0)."</select>"
         ."&nbsp;<input type=\"submit\" name=\"Ok\" value=\""._CHECKCATEGORIES."\"></font></form>"
         ."</center>";
    CloseTable();
    include ("footer.php");
}
...
function web_links_admin_getConfig() {
    ...
    GraphicAdmin();
    OpenTable();
    print '<center><font size="3" class="pn-title"><b>'._WEBLINKSCONF.'</b></font></center>'
          .'<form action="admin.php" method="post">'
