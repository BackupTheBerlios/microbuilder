<?php
// File: $Id: wl-navigation.php,v 1.1 2004/03/01 10:09:03 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
function index()
{
    ...
    if ($numcats == 0) {
        ...
        while(list($cat_id, $title, $cdescription) = $result->fields)
        {
            ...
            if ($cdescription) {
                echo "<font class=\"pn-normal\">".pnVarPrepHTMLDisplay($cdescription)."</font><br />";
            }
...
function menu($mainlink) {
    ...
    echo "<center><a class=\"pn-logo\"  href=\"".$GLOBALS['modurl']."\">".pnConfigGetVar('sitename').' -- '._LINKPAGETITLE."</a><br /><br />";
    //echo "<center><a class=\"pn-normal\"  href=\"".$GLOBALS['modurl']."\">"._LINKPAGETITLE."</a><br />";
    echo "<form action=\"".$GLOBALS['modurl']."&amp;req=search\" method=\"post\">"
    ...
    if (pnSecAuthAction(0, 'Web Links::Category', '::', ACCESS_COMMENT)) {
