<?php
// File: $Id: wl-viewlink.php,v 1.1 2004/03/01 10:09:02 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
{
  echo "<center><font class=\"pn-sub\">"._SORTLINKSBY.": "
		.""._TITLE." (<a href=\"".$GLOBALS['modurl']."&amp;req=viewlink&amp;cid=".pnVarPrepForDisplay($cid)."&amp;orderby=titleA\">A</a>/<a class=\"pn-normal\" href=\"".$GLOBALS['modurl']."&amp;req=viewlink&amp;cid=".pnVarPrepForDisplay($cid)."&amp;orderby=titleD\">D</a>) "
		.""._DATE." (<a href=\"".$GLOBALS['modurl']."&amp;req=viewlink&amp;cid=".pnVarPrepForDisplay($cid)."&amp;orderby=dateA\">A</a>/<a class=\"pn-normal\" href=\"".$GLOBALS['modurl']."&amp;req=viewlink&amp;cid=".pnVarPrepForDisplay($cid)."&amp;orderby=dateD\">D</a>) "
		.""._RATING." (<a href=\"".$GLOBALS['modurl']."&amp;req=viewlink&amp;cid=".pnVarPrepForDisplay($cid)."&amp;orderby=ratingA\">A</a>/<a class=\"pn-normal\" href=\"".$GLOBALS['modurl']."&amp;req=viewlink&amp;cid=".pnVarPrepForDisplay($cid)."&amp;orderby=ratingD\">D</a>) "
		.""._POPULARITY." (<a href=\"".$GLOBALS['modurl']."&amp;req=viewlink&amp;cid=".pnVarPrepForDisplay($cid)."&amp;orderby=hitsA\">A</a>/<a class=\"pn-normal\" href=\"".$GLOBALS['modurl']."&amp;req=viewlink&amp;cid=".pnVarPrepForDisplay($cid)."&amp;orderby=hitsD\">D</a>)"
		."<br /><b>"._SITESSORTED.": ".pnVarPrepForDisplay($orderbyTrans)."</b><br><br></font></center>";
}
...
//    $column = &$pntable['links_categories_column'];
    ...
    echo "<center><font class=\"pn-normal\"><b>"._CATEGORY.": ".CatPath($cid,1,1,0)."</b></font><br />";
    if ($description <> "") {
    ...
    if ($numrows != 0) {
        $scount = 0;
        echo "<center><font class=\"pn-sub\">"._LALSOAVAILABLE." ".pnVarPrepForDisplay($title)." "._SUBCATEGORIES.":</font></center>"
        ...
        while(list($sid, $title) = $subresult->fields) {
            ...
            echo "<td valign=\"top\" nowrap><img src=\"modules/".$GLOBALS['name']."/images/folder.gif\"> <a class=\"pn-normal\" href=\"".$GLOBALS['modurl']."&amp;req=viewlink&amp;cid=".(int)pnVarPrepForStore($sid)."\">"
    ...
    echo "<table width=\"100%\" cellspacing=\"0\" cellpadding=\"4\" border=\"0\"><tr><td><font class=\"pn-normal\">";
