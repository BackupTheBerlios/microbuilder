<?php
// File: $Id: admin.php,v 1.1 2004/03/01 10:09:03 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
function BannersAdmin()
{
    ...
    if (pnConfigGetVar('banners') == 0) {
        OpenTable();
        echo "<center><br><i><b><font class=\"pn-normal\">"._IMPORTANTNOTE."</font></b></i><br><br>"
            ."<font class=\"pn-normal\">"._BANNERSNOTACTIVE."</font><br>"
            ."<font class=\"pn-normal\">"._TOACTIVATE."</font><br><br></center>";
        CloseTable();
    }
    ...
    if (pnSecAuthAction(0, 'Banners::Banner', '::', ACCESS_READ)) {
        ...
        echo "<center><font class=\"pn-title\"><b>"._ACTIVEBANNERS."</b></font></center><br>"
            ...
            ."<tr>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._BANTYPE."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._IMPRESSIONS."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._IMPLEFT."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._CLICKS."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._CLICKSPERCENT."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._CLIENTNAME."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._FUNCTIONS."</font></b></td>"
            ."</tr>";
        ...
        while(list($bid, $cid, $imptotal, $impmade, $clicks, $date, $name, $typ) = $result->fields) {
            ...
            if (pnSecAuthAction(0, 'Banners::Banner', "$clientname::$bid", ACCESS_READ)) {
                ...
                echo "<tr>"
                    ."<td bgcolor=\"$bgcolor2\" align=center><font class=\"pn-normal\">" . pnVarPrepForDisplay($typ) . "</font></td>"
                    ."<td bgcolor=\"$bgcolor2\" align=center><font class=\"pn-normal\">" . pnVarPrepForDisplay($impmade) . "</font></td>"
                    ."<td bgcolor=\"$bgcolor2\" align=center><font class=\"pn-normal\">" . pnVarPrepForDisplay($left) . "</font></td>"
                    ."<td bgcolor=\"$bgcolor2\" align=center><font class=\"pn-normal\">" . pnVarPrepForDisplay($clicks) . "</font></td>"
                    ."<td bgcolor=\"$bgcolor2\" align=center><font class=\"pn-normal\">" . pnVarPrepForDisplay($percent) . "%</font></td>"
                    ."<td bgcolor=\"$bgcolor2\" align=center><font class=\"pn-normal\">" . pnVarPrepForDisplay($name) . "</font></td>";
                if (pnSecAuthAction(0, 'Banners::Banner', "$clientname::$bid", ACCESS_EDIT)) {
                    echo "<td bgcolor=\"$bgcolor2\" align=center><font class=\"pn-normal\"><a href=\"admin.php?module="
                    ...
                    if (pnSecAuthAction(0, 'Banners::Banner', "$clientname::$bid", ACCESS_DELETE)) {
                        ...
                        ."&amp;op=BannerDelete&amp;bid=$bid&amp;ok=0\">"._DELETE."</a></font></td>";
                    } else {
                        echo "</font></td>";
                    }
                } else {
...
/* Finished Banners List */
    if (pnSecAuthAction(0, 'Banners::Banner', '::', ACCESS_READ)) {
        ...
        echo "<center><font class=\"pn-title\"><b>"._FINISHEDBANNERS."</b></font></center><br>"
            ...
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._IMP."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._CLICKS."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._CLICKSPERCENT."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._DATESTARTED."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._DATEENDED."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._CLIENTNAME."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._FUNCTIONS."</font></b></td></tr>";
        ...
        while(list($bid, $cid, $impressions, $clicks, $datestart, $dateend, $name) = $result->fields) {
            ...
            if (pnSecAuthAction(0, 'Banners::Banner', "$clientname::$bid", ACCESS_READ)) {
                ...
                echo "<tr>"
                    ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($impressions) . "</font></td>"
                    ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($clicks) . "</font></td>"
                    ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($percent) . "%</font></td>"
                    ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($datestart) . "</font></td>"
                    ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($dateend) . "</font></td>"
                    ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($name) . "</font></td>";
                if (pnSecAuthAction(0, 'Banners::Banner', "$clientname::$bid", ACCESS_DELETE)) {
                    echo "<td bgcolor=\"$bgcolor2\" align=\"center\"><a href=\"admin.php?module="
                    .$GLOBALS['module']."&amp;op=BannerFinishDelete&amp;bid=$bid&amp;authid=" . pnSecGenAuthKey() . "\"><font class=\"pn-normal\">"._DELETE."</font></a></td>";
                } else {
                    echo "<td bgcolor=\"$bgcolor2\">&nbsp;</td>";
                }
                echo "</tr>";
    ...
    if (pnSecAuthAction(0, 'Banners::Client', '::', ACCESS_READ)) {
        ...
        echo "<center><font class=\"pn-title\"><b>"._ADVERTISINGCLIENTS."</b></font></center><br>"
            ."<table width=\"100%\" border=\"0\"><tr>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._CLIENTNAME."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._ACTIVEBANNERS2."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._CONTACTNAME."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._CONTACTEMAIL."</font></b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._FUNCTIONS."</font></b></td></tr>";
        ...
        while(list($cid, $name, $contact, $email) = $result->fields) {
            ...
            echo "<tr>"
                ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($name) . "</font></td>"
                ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($numrows) . "</font></td>"
                ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($contact) . "</font></td>"
                ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($email) . "</font></td>";
            if (pnSecAuthAction(0, 'Banners::Client', "$name::$cid", ACCESS_EDIT)) {
                ...
                if (pnSecAuthAction(0, 'Banners::Client', "$name::$cid", ACCESS_DELETE)) {
                    echo " | <a href=\"admin.php?module=".$GLOBALS['module']
                    ."&amp;op=BannerClientDelete&amp;cid=$cid\">"._DELETE."</a></font></td></tr>";
                } else {
                    echo "</font></td></tr>";
                }
            } else {
    ...
    if (pnSecAuthAction(0, 'Banners::Banner', '::', ACCESS_ADD)) {
        ...
        if(!$result->EOF) {
            OpenTable();
            echo "<center><font class=\"pn-title\"><b>"._ADDNEWBANNER."</b></font></center><br><br>"
                ."<form action=\"admin.php\" method=\"post\">"
                ."<font class=\"pn-normal\">"._CLIENTNAME.":</font>"
                ."<select name=\"cid\">";
            ...
            echo "</select><br>"
                    ."<font class=\"pn-normal\">"._PURCHASEDIMPRESSIONS.": <input type=\"text\" name=\"imptotal\" size=\"12\" maxlength=\"11\"> 0 = "._UNLIMITED."</font><br>"
                ."<font class=\"pn-normal\">"._BANTYPE.":</font> <input type=\"text\" name=\"type\" size=\"2\" maxlength=\"2\"><br>"
                ."<font class=\"pn-normal\">"._IMAGEURL.":</font> <input type=\"text\" name=\"imageurl\" size=\"50\" maxlength=\"250\"><br>"
                ."<font class=\"pn-normal\">"._CLICKURL.":</font> <input type=\"text\" name=\"clickurl\" size=\"50\" maxlength=\"250\"><br>"
    ...
    if (pnSecAuthAction(0, 'Banners::Client', '::', ACCESS_ADD)) {
        ...
        echo"<form action=\"admin.php\" method=\"post\">
		     <center><font class=\"pn-title\"><b>"._ADDCLIENT."</b></font><font class=\"pn-normal\"></center><br><br>
...
// Access Banner Settings
    OpenTable();
    echo "<center><font class=\"pn-title\"><b>"._BANNERSCONF."</b></font></center><br /><br />";
    echo "<a href=\"admin.php?module=".$GLOBALS['module']."&amp;op=getConfig\"><font class=\"pn-normal\">"._BANNERSCONF."</font></a>";
    CloseTable();
    include ("footer.php");
}
...
function BannerDelete()
{
    ...
    if($ok == 1) {
        ...
        OpenTable();
        echo "<center><b><font class=\"pn-normal\">"._DELETEBANNER."</font></b><br><br>"
            ."<a href=\"$clickurl\"><img src=\"$imageurl\" border=\"1\" alt=\"\"></a><br>"
            ."<a href=\"$clickurl\">$clickurl</a><br><br>"
            ."<table width=\"100%\" border=\"0\"><tr>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._ID."</font><b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._IMPRESSIONS."</font><b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._IMPLEFT."</font><b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._CLICKS."</font><b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._CLICKSPERCENT."</font><b></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><b><font class=\"pn-normal\">"._CLIENTNAME."</font><b></td></tr>";
        $percent = substr(100 * $clicks / $impmade, 0, 5);
        if($imptotal==0) {
            $left = _UNLIMITED;
        } else {
        ...
        echo "<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($bid) . "</font></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($impmade) . "</font></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($left) . "</font></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($clicks) . "</font></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($percent) . "%</font></td>"
            ."<td bgcolor=\"$bgcolor2\" align=\"center\"><font class=\"pn-normal\">" . pnVarPrepForDisplay($name) . "</font></td></tr>";
        echo "</td></tr></table><br>"
        ."<font class=\"pn-normal\">"._SURETODELBANNER."</font><br><br>"
        ."<font class=\"pn-normal\">[ <a href=\"admin.php?module=".$GLOBALS['module']."&amp;op=BannersAdmin\">"
        ._NO."</a> | <a href=\"admin.php?module=".$GLOBALS['module']."&amp;op=BannerDelete&amp;bid=$bid&amp;ok=1&amp;authid=" . pnSecGenAuthKey() . "\">"
        ._YES."</a> ]</font></center><br><br>";
        CloseTable();
        include("footer.php");
    }
}
...
function BannerEdit($bid) {
    ...
    OpenTable();
    echo"<center><font class=\"pn-title\">"
        ."<b>"._EDITBANNER."</b></font></center><br><br>"
        ."<center><img src=\"$imageurl\" border=\"1\" alt=\"\"></center><br><br>"
        ."<form action=\"admin.php\" method=\"post\">"
        ."<font class=\"pn-normal\">"._CLIENTNAME.":</font> "
        ."<select name=\"cid\">";
    ...
    echo "<br><font class=\"pn-normal\">"._ADDIMPRESSIONS.":</font> <input type=\"text\" name=\"impadded\" size=\"12\" maxlength=\"11\"><font class=\"pn-normal\"> "._PURCHASED.": <b>" . pnVarPrepForDisplay($impressions) . "</b> "._MADE.": <b>" . pnVarPrepForDisplay($impmade) . "</b></font><br>"
        ."<font class=\"pn-normal\">"._BANTYPE.": </font><input type=\"text\" name=\"type\" size=\"2\" maxlength=\"2\" value=\"$type\"><br>"
        ."<font class=\"pn-normal\">"._IMAGEURL.":</font><input type=\"text\" name=\"imageurl\" size=\"50\" maxlength=\"255\" value=\"$imageurl\"><br>"
        ."<font class=\"pn-normal\">"._CLICKURL.":</font><input type=\"text\" name=\"clickurl\" size=\"50\" maxlength=\"255\" value=\"$clickurl\"><br>"
...
function BannerClientDelete()
{
    ...
    if ($ok==1) {
        ...
        OpenTable();
        echo "<center><b><font class=\"pn-normal\">"._DELETECLIENT.": $name</b><br><br>
            "._SURETODELCLIENT."</font><br><br>";
        $column = $pntable['banner_column'];
        $result = $dbconn->Execute("SELECT $column[imageurl], $column[clickurl] 
                                   FROM $pntable[banner] 
                                   WHERE $column[cid]='".pnVarPrepForStore($cid)."'");
        if($result->EOF) {
            echo "<font class=\"pn-normal\">"._CLIENTWITHOUTBANNERS."</font><br><br>";
        } else {
            echo "<b><font class=\"pn-normal\">"._WARNING."!!!</b><br>
                "._DELCLIENTHASBANNERS.":</font><br><br>";
        }
        ...
        echo "<font class=\"pn-normal\">"._SURETODELCLIENT."<br><br>
        ...
        ._YES."</a> ]</font></center><br><br></center>";
        CloseTable();
        include("footer.php");
    }
}
...
function BannerClientEdit()
{
    ...
    echo "<center><font class=\"pn-title\"><b>"._EDITCLIENT."</b></font></center><br><br>"
        ."<form action=\"admin.php\" method=\"post\">"
        ."<font class=\"pn-normal\">"._CLIENTNAME.": <input type=\"text\" name=\"name\" value=\"$name\" size=\"30\" maxlength=\"60\"></font><br>"
        ."<font class=\"pn-normal\">"._CONTACTNAME.": <input type=\"text\" name=\"contact\" value=\"$contact\" size=\"30\" maxlength=\"60\"></font><br>"
        ."<font class=\"pn-normal\">"._CONTACTEMAIL.": <input type=\"text\" name=\"email\" size=30 maxlength=\"60\" value=\"$email\"></font><br>"
        ."<font class=\"pn-normal\">"._CLIENTLOGIN.": <input type=\"text\" name=\"login\" size=12 maxlength=\"10\" value=\"$login\"></font><br>"
        ."<font class=\"pn-normal\">"._CLIENTPASSWD.": <input type=\"text\" name=\"passwd\" size=12 maxlength=\"10\" value=\"$passwd\"></font><br><br>"
        ."<font class=\"pn-normal\">"._EXTRAINFO."<br><textarea name=\"extrainfo\" cols=\"80\" rows=\"10\">$extrainfo</textarea></font><br>"
...
function banners_admin_getConfig()
{
    ...
    GraphicAdmin();
    OpenTable();
    print '<center><font size="3" class="pn-title"><b>'._BANNERSCONF.'</b></font></center><br />'
          .'<form action="admin.php" method="post">'
