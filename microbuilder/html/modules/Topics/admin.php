...
function topicsmanager()
{
    ...
    if (pnSecAuthAction(0, 'Topics::Topic', '::', ACCESS_ADD)) {
        ...
        echo "<center><font class=\"pn-title\"><b>"._ADDATOPIC."</b></font></center><br />"
            ...
            ."<b><font class=\"pn-normal\">"._TOPICNAME.":</b><br /><font class=\"pn-sub\">"._TOPICNAME1."<br />"
            .""._TOPICNAME2."</font><br />"
...
function topicedit()
{
    ...
    echo "<img src=\"$tipath$topicimage\" border=\"0\" align=\"right\" alt=\"$topictext\">"
        ...
        ."<br /><br />"
        ."<b><font class=\"pn-normal\">"._TOPICNAME.":</font></b><br /><font class=\"pn-sub\">"._TOPICNAME1."<br />"
        .""._TOPICNAME2."</font><br />"
    ...
    if (pnSecAuthAction(0, 'Topics::Related', "$topicname::", ACCESS_EDIT)) {
        echo "<font class=\"pn-normal\"><b>"._ACTIVERELATEDLINKS.":</b></font><br />";
        OpenTable2();
        ...
        while(list($rid, $name, $url) = $res->fields) {
            ...
            $res->MoveNext();
            echo "<tr><td align=\"center\"><font class=\"pn-normal\"><strong><big>&middot;</big></strong>&nbsp;&nbsp;<a href=\"$url\">$name</a></font></td>"
                    ."<td align=\"center\"><font class=\"pn-normal\"><a href=\"".pnVarPrepForDIsplay($url)."\">$url</a></font></td>";
            if (pnSecAuthAction(0, 'Topics::Related', "$topicname::", ACCESS_EDIT)) {
                echo "<td align=\"right\"><font class=\"pn-normal\">[ <a href=\"admin.php?module=".$GLOBALS['module']
				     ."&amp;op=relatededit&amp;tid=$topicid&amp;rid=".pnVarPrepForDIsplay($rid)."&amp;authid=$authid\">"._EDIT."</a>";
                if (pnSecAuthAction(0, 'Topics::Related', "$topicname::", ACCESS_DELETE)) {
                    echo " | <a href=\"admin.php?module=".$GLOBALS['module']."&amp;op=relateddelete&amp;tid=$topicid&amp;rid="
					    .pnVarPrepForDIsplay($rid)."&amp;authid=$authid\">"._DELETE."</a> ]";
                } else {
                    echo " ]";
                }
				echo "</font>";
...
function relatededit()
{
    ...
    echo "<center>"
        ...
        ."<b><font class=\"pn-title\">"._TOPIC.":</font></b> $topictext</center>"
...
function topicdelete()
{
	...
	$column = &$pntable['topics_column'];
        ...
        echo "<center><img src=\"$tipath$topicimage\" border=\"0\" alt=\"$topictext\"><br /><br />"
            ."<b><font class=\"pn-title\">"._DELETETOPIC." $topictext</font></b><br /><br />"
            ."<font class=\"pn-normal\">"._TOPICDELSURE." <i>$topictext</i>?<br />"
...
function topics_admin_getConfig() {
    ...
    GraphicAdmin();
    OpenTable();
    print '<center><font size="3" class="pn-title"><b>'._TOPICSCONF.'</b></font></center><br />'
          .'<form action="admin.php" method="post">'
