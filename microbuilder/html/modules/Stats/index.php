<?php // $Id: index.php,v 1.1 2004/03/01 10:08:59 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
if (_24HOUR == true) {
	for ($hour = 0; $hour < 24; $hour++) {
		...
		$label = "<font class=\"pn-normal\">".pnVarPrepForDisplay($hour).":00 - ".pnVarPrepForDisplay($hour).":59";
	    echo "\t<tr>\n"
    	    ."\t\t<td align=\"right\">$label:</td>\n"
        	."\t\t<td>".mk_percbar(round((100*$hourhitamount[$hour])/$hourbesthits,0),200,false,$ThemeSel,"$percent %")."&nbsp;\n"
	        ."<font class=\"pn-normal\">$percent % ($hourhitamount[$hour])</font></td>\n"
    	    ."\t</tr>\n";
	}
} else {
	for ($hour = 1; $hour < 24; $hour++) {
		...
		else $label = "<font class=\"pn-normal\">".pnVarPrepForDisplay($hour % 12)." pm";
	    echo "\t<tr>\n"
    	    ."\t\t<td align=\"right\"><font class=\"pn-normal\">$label:</font></td>\n"
        	."\t\t<td>".mk_percbar(round((100*$hourhitamount[$hour])/$hourbesthits,0),200,false,$ThemeSel,"$percent %")."&nbsp;\n"
	        ."<font class=\"pn-normal\">$percent % ($hourhitamount[$hour])</font></td>\n"
    	    ."\t</tr>\n";
	}
    ...
    echo "\t<tr>\n"
   	    ."\t\t<td align=\"right\"><font class=\"pn-normal\">12 pm:</font></td>\n"
       	."\t\t<td>".mk_percbar(round((100*$hourhitamount[0])/$hourbesthits,0),200,false,$ThemeSel,"$percent %")."&nbsp;\n"
	    ."<font class=\"pn-normal\">$percent % ($hourhitamount[0])</font></td>\n"
        ."\t</tr>\n";
}
echo "</table>\n";
CloseTable();
...
for ($weekday=1;$weekday<=6;$weekday++) {
    echo "\t<tr>\n"
        ."\t\t<td><font class=\"pn-normal\">$weekdaynames[$weekday]:</font></td>\n"
        ."\t\t<td><font class=\"pn-normal\">".mk_percbar(round((100*$weekhitamount[$weekday])/$weekdaybesthits,0),200,false,$ThemeSel)."&nbsp;\n"
        .round((100*$weekhitamount[$weekday])/$sumweek,2),"% ($weekhitamount[$weekday])</font></td>\n"
        ."\t</tr>\n";
}
echo "\t<tr>\n"
    ."\t\t<td><font class=\"pn-normal\">$weekdaynames[0]:</font></td>\n"
    ."\t\t<td><font class=\"pn-normal\">".mk_percbar(round((100*$weekhitamount[0])/$weekdaybesthits,0),200,false,$ThemeSel)."&nbsp;\n"
    .round((100*$weekhitamount[0])/$sumweek,2),"% ($weekhitamount[0])</font></td>\n"
    ."\t</tr>\n";
echo "</table>\n";
CloseTable();
...
{
    echo "\t<tr>\n"
        ."\t\t<td><font class=\"pn-normal\">$monthnames[$month]:</font></td>\n"
        ."\t\t<td><font class=\"pn-normal\">".mk_percbar(round((100*$monthhitamount[$month])/$monthbesthits,0),200,false,$ThemeSel)."&nbsp;\n"
        .round((100*$monthhitamount[$month])/$summon,2),"% ($monthhitamount[$month])</font></td>\n"
        ."\t</tr>\n";
}
echo "</table>\n";
CloseTable();
...
$algn = "align=\"right\"";
echo "<br /><table cellspacing=\"0\" cellpadding=\"2\" border=\"0\" align=\"center\">\n";
echo "<tr $vlgn><td><img src=\"modules/$ModName/images/users.gif\" border=\"0\" alt=\"\"></td><td>&nbsp;<font class=\"pn-normal\">"._REGUSERS."</font></td><td $algn><font class=\"pn-normal\">".pnVarPrepForDisplay($unum-1)."</font></td></tr>\n";
