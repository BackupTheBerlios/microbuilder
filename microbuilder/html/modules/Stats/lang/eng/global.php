...
define('_MOALLBESTDAY','Our busiest day so far was ');
define('_MOALLWORSTDAY','was fairly quiet');
define('_MODAPR','April');
define('_MODAT',') is at');
define('_MODAUG','August');
define('_MODBYHOUR','Visitors by hour');
define('_MODBYMONTH','Visitors by month');
define('_MODBYWEEK','Visitors by day of the week');
define('_MODDEC','December');
define('_MODFANSONLY','while only our dedicated fans show up at');
define('_MODFEB','February');
define('_MODFRI','Friday');
define('_MODINAVRG','On average, our busiest hour (with');
define('_MODISNTOURDAY','is a slower day, with a total of');
...
define('_MODOCLOCK','<B>:00</B>,');
define('_MODOCT','October');
define('_MODON','Most people visit us on');
