<?php
// File: $Id: dl-viewdownload.php,v 1.1 2004/03/01 10:09:06 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
// DJD - Fix - Auth used to be called with Cat name instead of SubCat Name 04/06/2002
    ...
    echo "<center><font class=\"pn-title\"><a class=\"pn-normal\" href=\"".$GLOBALS['modurl']."\">"._MAIN."</a> / <a class=\"pn-normal\" href=\"".$GLOBALS['modurl']."&amp;req=viewdownload&amp;cid=$cid\">".pnVarPrepForDisplay($title)."</a> / ".pnVarPrepForDisplay($stitle)."</font></center>";
    $orderbyTrans = convertorderbytrans($orderby);
