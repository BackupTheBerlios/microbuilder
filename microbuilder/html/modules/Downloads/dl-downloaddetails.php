<?php
// File: $Id: dl-downloaddetails.php,v 1.1 2004/03/01 10:09:05 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
function outsidedownloadsetup($lid) {
   ...
   //    <font class=\"pn-normal\">"._THENUMBER." \"$lid\" "._IDREFER1." $sitename"._IDREFER2."</font><br><br>
    OpenTable();
...
&lt;/form&gt;\n
    ...
    <tr><td align=\"center\"><font class=\"pn-normal\">"._VOTE4THISSITE."</font></td></tr>
    <tr><td>
...
// optimization end -- besfred
    ...
    echo pnModCallHooks('item', 'display', $lid, "modules.php?op=modload&name=$GLOBALS[ModName]&file=index&req=viewdownloaddetails&lid=$lid&ttitle=$ttitle");
...
function modifydownloadrequest($lid)
{
    ...
    if ($blocknow != 1) {
        ...
        while(list($cid, $sid, $title, $url, $description, $name, $email, $filesize, $version, $homepage) = $result->fields) {
            ...
            ."<font class=\"pn-normal\">"._DESCRIPTION.":</font> <br><textarea name=\"description\" cols=\"80\" rows=\"10\">$description</textarea><br><br>";
