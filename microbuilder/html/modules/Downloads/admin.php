<?php
// File: $Id: admin.php,v 1.1 2004/03/01 10:09:05 mbertier Exp $
// ----------------------------------------------------------------------
    ...
    if (!$result->EOF) {
        ...
        while(list($lid, $cid, $sid, $title, $url, $description, $name, $email, $submitter, $filesize, $version, $homepage) = $result->fields)	 {
            ...
            echo " <tr><td colspan=\"4\"><form action=\"admin.php\" method=\"post\">"
                ...
                ."\n<tr><td colspan=\"4\">"._DESCRIPTION.": <br /><textarea name=\"description\" cols=\"80\" rows=\"10\">$description</textarea></td></tr>"
 ...
 */
    ...
    echo "</select><br /><br /><br />"
        .""._DESCRIPTION255."<br /><textarea name=\"description\" cols=\"80\" rows=\"10\"></textarea><br /><br /><br />"
...
function DownloadsModDownload() {
    ...
    */
    ...
    while(list($cid, $sid, $title, $url, $description, $name, $email, $hits, $filesize, $version, $homepage) = $result->fields) {
        ...
        ."\n<tr><td colspan=\"4\">"._FILESIZE.": <input type=\"text\" name=\"filesize\" size=\"12\" maxlength=\"11\" value=\"$filesize\"></td></tr>"
        ."\n<tr><td colspan=\"4\">"._VERSION.": <input type=\"text\" name=\"version\" size=\"11\" maxlength=\"10\" value=\"$version\"></td></tr>"
        ."\n<tr><td colspan=\"4\">"._HOMEPAGE.": <input type=\"text\" name=\"homepage\" size=\"50\" maxlength=\"200\" value=\"http://$homepage\"> [ <a href=\"http://$homepage\">"._VISIT."</a> ]</td></tr>"
...
function downloads_admin_getConfig() {
    ...
    $sel_newdownloads['30'] = '';
    $sel_newdownloads['50'] = '';
    $sel_newdownloads[pnConfigGetVar('newdownloads')] = ' selected';
    $sel_topdownloads['10'] = '';
    $sel_topdownloads['15'] = '';
    $sel_topdownloads['20'] = '';
    $sel_topdownloads['25'] = '';
    $sel_topdownloads['30'] = '';
    $sel_topdownloads['50'] = '';
    $sel_topdownloads[pnConfigGetVar('topdownloads')] = ' selected';
    ...
    $sel_downloadsresults[pnConfigGetVar('downloadsresults')] = ' selected';
    ...
    print '<center><font size="3" class="pn-title">'._DOWNLOADSCONF.'</b></font></center><br />'
       ...
       .'</td></tr>'
        .'<tr><td class="pn-normal">'
        ._TOPDOWNLOADSPERCENTRIGGER."</td><td><input type=\"text\" name=\"xtopdownloadspercentrigger\" value=\"".pnConfigGetVar('topdownloadspercentrigger')."\" size=\"4\" class=\"pn-normal\">"
       .'</td></tr>'
        .'<tr><td class="pn-normal">'
        ._TOPDOWNLOADS."</td><td><input type=\"text\" name=\"xtopdownloads\" value=\"".pnConfigGetVar('topdownloads')."\" size=\"4\" class=\"pn-normal\">"
       .'</td></tr>'
        .'<tr><td class="pn-normal">'
        ._MOSTPOPDOWNLOADSPERCENTRIGGER."</td><td><input type=\"text\" name=\"xmostpopdownloadspercentrigger\" value=\"".pnConfigGetVar('mostpopdownloadspercentrigger')."\" size=\"4\" class=\"pn-normal\">"
       .'</td></tr>'
        .'<tr><td class="pn-normal">'
        ._MOSTPOPDOWNLOADS."</td><td><input type=\"text\" name=\"xmostpopdownloads\" value=\"".pnConfigGetVar('mostpopdownloads')."\" size=\"4\" class=\"pn-normal\">"
       .'</td></tr>'
        .'<tr><td class="pn-normal">'
       ...
       .'</td></tr>'
        ...
        .'<select name="xnewdownloads" size="1" class="pn-normal">'
        ...
        .'<select name="xtopdownloads" size="1" class="pn-normal">'
        ...
        .'<select name="xdownloadsresults" class="pn-normal">'
