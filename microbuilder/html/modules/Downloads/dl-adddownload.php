<?php
// File: $Id: dl-adddownload.php,v 1.1 2004/03/01 10:09:06 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
function AddDownload() {
    ...
    if (pnUserLoggedIn() || pnConfigGetVar('downloads_anonadddownloadlock') != 1) {
        ...
        ."<font class=\"pn-normal\">"._DOWNLOADNAME."</font>: <input type=\"text\" name=\"title\" size=\"50\" maxlength=\"100\"><br>"
        ."<font class=\"pn-normal\">"._FILEURL."</font>: <input type=\"text\" name=\"url\" size=\"50\" maxlength=\"250\" value=\"http://\"><br>";
        ...
        echo "</select><br><br>"
        ."<font class=\"pn-normal\">"._LDESCRIPTION."</font><br><textarea name=\"description\" cols=\"80\" rows=\"10\"></textarea><br><br>"
        ...
        ."<font class=\"pn-normal\">"._FILESIZE."</font>: <input type=\"text\" name=\"filesize\" size=\"10\" maxlength=\"10\"> <font class=\"pn-normal\">("._INBYTES.")</font><br>"
        ."<font class=\"pn-normal\">"._VERSION."</font>: <input type=\"text\" name=\"version\" size=\"10\" maxlength=\"10\"><br>"
