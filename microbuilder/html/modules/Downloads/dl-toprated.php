<?php
// File: $Id: dl-toprated.php,v 1.1 2004/03/01 10:09:05 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
function TopRated($ratenum, $ratetype)
{
    ...
    if ($topdownloadspercentrigger == 1) {
        echo "<center><font class=\"pn-title\">"._DBESTRATED." ".pnVarPrepForDisplay($topdownloadspercent)."% ("._OF." ".pnVarPrepForDisplay($totalrateddownloads)." "._TRATEDDOWNLOADS.")</font></center><br>";
    } else {
        echo "<center><font class=\"pn-title\">"._DBESTRATED." ".pnVarPrepForDisplay($topdownloads)."</font></center><br>";
    }
    echo "</td></tr>"
