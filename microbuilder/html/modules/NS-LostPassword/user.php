<?php // File: $Id: user.php,v 1.1 2004/03/01 10:09:01 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
function lostpassword_user_lostpassscreen()
{
    ...
    echo "<font class=\"pn-title\">"._PASSWORDLOST."</font><br><br>\n"
        ...
        ."<tr>\n"
        ."<td><font class=\"pn-normal\">"._NICKNAME.": </font></td><td><input type=\"text\" name=\"uname\" size=\"26\" maxlength=\"25\"></td></tr>"
        ."<tr><td><font class=\"pn-normal\">"._EMAIL.": </font></td><td><input type=\"text\" name=\"email\" size=\"60\" maxlength=\"60\"></td>\n"
        ."</tr>\n"
