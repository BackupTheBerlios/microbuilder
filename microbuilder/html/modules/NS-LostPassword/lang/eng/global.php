...
define('_IFYOUDIDNOTASK','If you didn\'t request the password, don\'t worry. You\'re seeing this message, not \'them\'. If this was an error just login with your new password.');
define('_IFYOUDIDNOTASK2','If you didn\'t ask for this, don\'t worry. Just delete this email.');
define('_MAILED','mailed.');
define('_NOPROBLEM','
No problem!<br /><br />
Just type your username and click the send button and an email will be sent to you with a \'Confirmation Code\'. After you receive the confirmation code, re-type your username and the \'Confirmation Code\' into the form. After this form is submitted, a new password will be generated and emailed back to you.<br /><br />');
define('_PASSWORD4','Password for');
define('_PASSWORDLOST','Lost your password?');
define('_SENDPASSWORD','Send password');
define('_SORRYNOUSERINFO','Sorry but there is no corresponding user information.');
...
define('_YOUCANCHANGE','You can change your password after you login at');
