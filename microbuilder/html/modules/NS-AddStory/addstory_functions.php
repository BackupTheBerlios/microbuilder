<?php
// File: $Id: addstory_functions.php,v 1.1 2004/03/01 10:09:07 mbertier Exp $
// ----------------------------------------------------------------------
...
{
    echo "<font class=\"pn-normal\"><br><b>"._PUBLISHINHOME."</b>&nbsp;&nbsp;";
    if (($ihome == 0) OR ($ihome == '')) {
        $sel1 = ' checked';
        $sel2 = '';
    }
...
function storyEdit($subject, $hometext, $bodytext, $notes, $topic, $ihome, $catid, $alanguage, $comm, $aid, $informant, $format_type=0)
{
    ...
    echo "<font class=\"pn-normal\"><b>"._TITLE."</b><br>"
...
// new function !
    ...
    echo "</font><br><br><b>"._STORYTEXT."</b><br>"
    ...
    echo "<br><br><b>"._EXTENDEDTEXT."</b><br>"
        ."<textarea cols=\"80\" rows=\"10\" name=\"bodytext\">";
    ...
    if (pnSecAuthAction(0, 'Stories::', "$subject::", ACCESS_EDIT)) {
        echo "<b>"._NOTES."</b><br><textarea cols=\"80\" rows=\"5\" name=\"notes\">" . pnVarPrepForDisplay(unnltobr($notes)) . "</textarea><br><br>";
        } else {
