<?php
// File: $Id: pnuser.php,v 1.1 2004/03/01 10:09:02 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
function credits_user_main()
{
	...
	// Credits
    $row = array();
	$row[] = $output->Text('<input type="image" src="modules/Credits/pnimages/credits.gif" name="submit" alt="'._CREDITSCREDITS.'"> ');
	...
	// Help
    $row = array();
	$row[] = $output->Text('<input type="image" src="modules/Credits/pnimages/help.gif" name="submit" alt="'._CREDITSHELP.'"> ');
	...
	// License
    $row = array();
	$row[] = $output->Text('<input type="image" src="modules/Credits/pnimages/license.gif" name="submit" alt="'._CREDITSLICENSE.'"> ');
    ...
    foreach($mods as $mods) {
		...
		if ($modversion['official']) {
			$creditsname .= "<img src=\"modules/Credits/pnimages/official.gif\" alt=\"\" $oimg[3]>";
		}
		...
		if ($modversion['credits'] <> "")
        {
			...
			$row2 = array();
			$row2[] = $creditform->Text('<input type="image" src="modules/Credits/pnimages/credits.gif" name="submit" alt="'._CREDITSCREDITS.'"> ');
        ...
        if ($modversion['help'] <> "")
        {
			...
			$row2 = array();
			$row2[] = $helpform->Text('<input type="image" src="modules/Credits/pnimages/help.gif" name="submit" alt="'._CREDITSHELP.'"> ');
        ...
        if ($modversion['license'] <> "")
        {
			...
			$row2 = array();
			$row2[] = $licenseform->Text('<input type="image" src="modules/Credits/pnimages/license.gif" name="submit" alt="'._CREDITSLICENSE.'"> ');
		...
		if ($modversion['changelog'] <> "")
        {
			...
			$row2 = array();
			$row2[] = $logform->Text('<input type="image" src="modules/Credits/pnimages/credits.gif" name="submit" alt="'._CREDITSCHANGELOG.'"> ');
