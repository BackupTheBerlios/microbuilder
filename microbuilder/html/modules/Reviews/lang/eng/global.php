...
define('_CHANGES','Any small changes necessary can be made below:');
...
define('_CHECKNAME','You must enter both your name and your e-mail');
...
define('_IMAGE','Image');
define('_INVALIDEMAIL','Invalid e-mail (eg: you@hotmail.com)');
...
define('_MODREVINFO','You can delete/modify reviews by browsing <a href="modules.php?op=modload&amp;name=Reviews&amp;file=index">reviews</a>');
define('_MYSCORE','My score:');
define('_NAMEPRODUCT','Name of the reviewed product.');
define('_NOREVIEW2ADD','No reviews to add');
define('_NOREVIEWS','There aren\'t any review for letter');
define('_PREMODS','Preview modifications');
define('_PRODUCTSITE','Product\'s official website. Make sure your URL starts with "http://"');
...
define('_REVIEWSADDNOAUTH','Not authorised to add reviews');
define('_REVIEWSCOMMENTNOAUTH','Not authorised to comment on reviews');
define('_REVIEWSDELNOAUTH','Not authorised to delete reviews');
define('_REVIEWSEDITNOAUTH','Not authorised to edit reviews');
define('_REVIEWSINDB','Reviews in the database');
define('_REVIEWSINVALIDID','Invalid review ID');
define('_REVIEWSLETTER','Reviews for letter');
define('_REVIEWSNOAUTH','Not authorised for reviews administration');
define('_REVIEWSREADNOAUTH','Not authorised to add reviews');
define('_REVIEWSSUBMITNOAUTH','Not authorised to submit reviews');
define('_REVIMGINFO','Store your 150*150 image in modules/Reviews/images');
define('_REVTITLE','Reviews page title');
define('_REVWAITING','Reviews awaiting validation');
define('_RIMAGEFILE','Image filename');
define('_RIMAGEFILEREQ','Name of the cover image, located in modules/Reviews/images/. Not required.');
define('_RLINK','Link:');
...
define('_RWELCOME','Welcome to the Reviews section');
define('_SELECTSCORE','This product\'s score');
...
define('_YOURNICK','Your username:');
?>