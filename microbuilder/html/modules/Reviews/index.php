<?php // $Id: index.php,v 1.1 2004/03/01 10:09:02 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
	...
	/**
        ...
        if (isset($error) && $error == 1)
            ...
            echo "<input type=\"hidden\" name=\"id\" value=$id>
               ...
               "._CHANGES."<br><textarea name=\"text\" rows=10 cols=80>".pnVarPrepHTMLDisplay($text)."</textarea>
            ...
            echo "<p><i>"._LOOKSRIGHT."</i><br>
               <input type=\"submit\" name=\"req\" value=\""._YES."\"> </form><hr>";
    				...
    				echo "<br><br><b>"._REVIEW.":</b><br>"
          		 ."<textarea name=\"text\" rows=\"10\" wrap=\"virtual\" cols=\"80\">".pnVarPrepHTMLDisplay($text)."</textarea><br>";
...
function showcontent()
{
    ...
    echo pnModCallHooks('item', 'display', $id, "modules.php?op=modload&name=$GLOBALS[ModName]&file=index&req=showcontent&id=$id");
        ...
        echo "</select></td>
                            ...
                            <tr>
                             <tr>
                                    ...
                                    <td><TEXTAREA class=\"pn-normal\" name=text rows=10 wrap=virtual cols=80>".pnVarPrepHTMLDisplay($text)."</TEXTAREA></td>
                            </tr>
                            <tr>
