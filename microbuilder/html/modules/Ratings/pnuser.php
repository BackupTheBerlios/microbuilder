<?php
// $Id: pnuser.php,v 1.1 2004/03/01 10:09:01 mbertier Exp $
// ----------------------------------------------------------------------
...
function ratings_user_display($args)
{
        ...
        switch($style) {
            ...
            case 'outoffivestars':
                ...
                for ($i=0; $i < $intrating; $i++) {
                    $output->Text('<IMG SRC="modules/Ratings/pnimages/star.gif" alt="">');
                }
                if ($fracrating >= 5) {
                    $output->Text('<IMG SRC="modules/Ratings/pnimages/halfstar.gif" alt="">');
                }
                $output->SetInputMode(_PNH_PARSEINPUT);
                break;
            case 'outoften':
    ...
    if (pnSecAuthAction(0, 'Ratings::', '::', ACCESS_COMMENT)) {
