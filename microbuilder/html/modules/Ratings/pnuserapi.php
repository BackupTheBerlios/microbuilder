<?php
// $Id: pnuserapi.php,v 1.1 2004/03/01 10:09:01 mbertier Exp $
// ----------------------------------------------------------------------
    ...
    if (!$result->EOF) {
        ...
        $sql = "UPDATE $ratingstable
                SET $ratingscolumn[rating] = '" . pnVarPrepForStore($newrating) . "',
                    $ratingscolumn[numratings] = '".pnVarPrepForStore($newnumratings)."'
                WHERE $ratingscolumn[rid] = '".pnVarPrepForStore($rid)."'";
        $dbconn->Execute($sql);
