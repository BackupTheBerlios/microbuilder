<?php
// $Id: pninit.php,v 1.1 2004/03/01 10:09:01 mbertier Exp $
// ----------------------------------------------------------------------
...
function autolinks_upgrade($oldversion)
{
    ...
    switch($oldversion) {    	
    	case 1.0:
    		// upgrade module type from 1 to 2
            ...
            $sql = "UPDATE $modulestable SET $modulescolumn[type]='2' WHERE $modulescolumn[name]='Autolinks'";
