...
if (!$result->EOF) {
    ...
    while(list($sid, $title, $time, $counter) = $result->fields) {
        ...
        if($counter>0) {
            ...
            echo "<font class=\"pn-normal\">&nbsp;$lugar:</font> <a href=\"modules.php?op=modload&amp;name=News&amp;file=article&amp;sid=$sid&amp;$commentlink\">" . pnVarPrepForDisplay($title) . "</a><font class=\"pn-normal\"> - ($counter "._READS.")</font><br>\n";
            $lugar++;
        }
        $result->MoveNext();
    }
