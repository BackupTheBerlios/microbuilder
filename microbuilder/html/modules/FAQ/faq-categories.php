<?php
// File: $Id: faq-categories.php,v 1.1 2004/03/01 10:08:58 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
function faq_admin_FaqCatNew()
{
    ...
    ."<font class=\"pn-normal\">"._CATEGORY.":</font></td><td><input type=\"text\" name=\"categoryname\" size=\"30\"></td>"
 ...
 //					  ^--- CSS class doesn't seem to kick in for this no biggie but still annoying -bharvey42
    ...
    echo "<td><font class=\"pn-normal\">"._PARENTC.": ";
...
function faq_admin_FaqCatEdit($var)
{
    ...
    OpenTable();
    echo "<center><font class=\"pn-title\"><b>"._EDITCATEGORY."</b></font></center>"
    ."<form action=\"admin.php\" method=\"post\">"
    ."<input type=\"hidden\" name=\"id_cat\" value=\"" . pnVarPrepHTMLDisplay($id_cat) ."\">"
    ."<table border=\"0\" width=\"100%\"><tr><td>"
    ."<font class=\"pn-normal\">"._CATEGORY.":</font></td><td><input type=\"text\" name=\"categoryname\" size=\"31\" value=\"".pnVarPrepHTMLDisplay($categories)."\">"
    .'<tr><td><font class=\"pn-normal\">'._LANGUAGE.':</font></td><td>';
...
function faq_admin_FaqCatDel($var)
{
    ...
    if($ok==1) {
        ...
        OpenTable();
        echo "<br><center><b><font class=\"pn-normal\">"._FAQDELWARNING."</font></b><br><br>";
    		echo "<font class=\"pn-normal\">[ <a href=\"admin.php?module=".$GLOBALS['module']."&amp;op=FaqCatDel&amp;id_cat=".$var['id_cat']."&amp;ok=1&amp;authid=$authid\">"
    		._YES."</a> | <a href=\"admin.php?module=".$GLOBALS['module']."&amp;op=main\">"._NO."</a> ]</font></center><br><br>";
    		CloseTable();
    		include 'footer.php';
    }
}
