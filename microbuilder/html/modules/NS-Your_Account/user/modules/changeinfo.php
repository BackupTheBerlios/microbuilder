<?php 
// $Id: changeinfo.php,v 1.1 2004/03/01 10:09:04 mbertier Exp $
// ----------------------------------------------------------------------
...
function edituser($htmltext)
{
    ...
    include("header.php");
    OpenTable();
    echo pnVarPrepHTMLDisplay($htmltext);
    ...
    while (!$result->EOF) {
        ...
        echo "<tr><td valign=\"top\"><font class=\"pn-normal\">" . $prop_label_text . "</font></td>" . "<td valign=\"top\" class=pn-normal>";
        switch ($prop_dtype) {
            ...
            case _UDCONST_CORE;
                ...
                switch ($prop_label) {
                    ...
                    case "_SIGNATURE":
                        ...
                        break;
                    case "_EXTRAINFO":
                        echo "<textarea cols=\"80\" rows=\"10\" name=\"bio\" class=\"pn-normal\">" . pnVarPrepForDisplay(pnUserGetVar('bio')) . "</textarea>" . "<br><font class=\"pn-normal\">" . _OPTIONAL . "</font>" . "&nbsp;<font class=\"pn-normal\">" . _CANKNOWABOUT . "</font></td>";
                        break;

                    case "_PASSWORD":
                        echo "<input type=\"password\" name=\"pass\" size=\"10\" maxlength=\"20\">&nbsp;&nbsp;<input type=\"password\" name=\"vpass\" size=\"10\" maxlength=\"20\">" . "&nbsp;<font class=\"pn-normal\">" . _TYPENEWPASSWORD . "</font>";
                        break;
                    default:
            ...
            case _UDCONST_STRING:
                ...
                echo "<input type=\"text\" name=\"dynadata[$prop_label]\" value=\"" . pnVarPrepForDisplay(pnUserGetVar($prop_label)) . "\" size=\"30\" maxlength=\"$prop_length\">" . "&nbsp;" . _OPTIONAL . "</td>";
                break;

            case _UDCONST_TEXT:
                echo "<textarea cols=\"80\" rows=\"10\" name=\"dynadata[$prop_label]\" class=\"pn-normal\">" . pnVarPrepForDisplay(pnUserGetVar($prop_label)) . "</textarea>" . "<br><font class=\"pn-normal\">" . _OPTIONAL . "</font>";
                break;

            case _UDCONST_FLOAT:
            case _UDCONST_INTEGER:
                echo "<input type=\"text\" name=\"dynadata[$prop_label]\" value=\"" . pnVarPrepForDisplay(pnUserGetVar($prop_label)) . "\" size=\"30\" maxlength=\"100\">" . "&nbsp;" . _OPTIONAL . "</td>";
                break;
        } 
        echo "</tr>\n";
    } 
