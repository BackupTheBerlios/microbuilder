<?php
// File: $Id: menu.php,v 1.1 2004/03/01 10:09:04 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
class menu_object
{
	...
	global $ModName;
      ...
      {
      	 $tdwidth = 100/$this->nb_column;
         echo  '<td align="center" width="'.$tdwidth.'%">';
      ...
      function draw_menu()
      {
         ...
         if ($this->title_file!='') echo '</a></center>';
         echo  "\n"
              .'<br>'."\n";
     //    if (($this->detail_menu) or ($GLOBALS['module']=='oldway'))
      //   {
           ...
           // {
           	   $currentlang = pnUserGetLang(); // fixed bug [ #357 ] empty pop up window
               if (file_exists($file="modules/".$GLOBALS['module']."/lang/".pnVarPrepForOS($currentlang)."/manual.html")) {
                  $hlpfile = $file;                  
