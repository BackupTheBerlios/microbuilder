...
define('_ISINTRANET','网站是在本地intranet或其它局域网(非internet)建立');
define('_INTRANETINFO','<b>注意：</b>如果您的网站不能通过完整的域名访问，您必须在<b>上面的选项</b>上打钩。例如，完整的域名如 www.postnuke.com 或 foo.bar.com；而不完整的域名如 foo.com、localhost、或 mysite.org。如果您没有正确设置该参数，您也许无法登录您的网站。');
define('_MADE','已创建。');
