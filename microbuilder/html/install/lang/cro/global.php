...
define('_INTRANETINFO','Vi morate izabrati opciju "intranet" ako VaŠ sajt ne koristi kompletno ime glavnog raèunala (host) za ulazak. Na primjer  kompletno ime glavnog raèunala (host) mogu biti www.postnuke.com i www.cronuke.com. Na primjer imena glavnog raèunala (host) koja nisu kompletna foo.com, localhost, i mysite.org. Ako Vi ne izaberete opciju "Intranet" a nemate kompletno ime glavnog raèunala (host), vi neæe moèi uæi u VaŠ sajt.');
define('_ISINTRANET','Ovaj sajt je na Intranetu ili je korišten<br> na jednom local Network koji nije internet');
