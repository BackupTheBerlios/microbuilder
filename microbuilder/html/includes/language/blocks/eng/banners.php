<?php
// File: $Id: banners.php,v 1.1 2004/03/01 10:09:13 mbertier Exp $
// ----------------------------------------------------------------------
...
define('_DEFINEBANNER',' (0,1,2) are reserved for the default banners, please use any number above that !');
?>