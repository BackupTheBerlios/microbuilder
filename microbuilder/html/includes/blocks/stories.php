<?php
// File: $Id: stories.php,v 1.1 2004/03/01 10:09:12 mbertier Exp $
// ----------------------------------------------------------------------
...
function blocks_stories_select($row)
{
    ...
    $output .= '></td></tr><tr><td class="pn-normal">' . _STORIESDISPLAYFRONTPAGE .
               ':</td><td><input type="radio" name="storiestype" value="3"';
    if ($vars['storiestype'] == 3) {
        $output .= ' checked';
    }
    $output .= '></td></tr><tr><td class="pn-normal">' . _STORIESDISPLAYNONFRONTPAGE .
    ...
    // Which topic
    $output .= '<tr><td class="pn-normal">' . _STORIESTOPIC . ':</td><td><select name="topic" size="1">';
    ...
    // Which category
    $output .= '<tr><td class="pn-normal">' . _STORIESCATEGORY . ':</td><td><select name="category" size="1">';
    $output .= "<option value=\"-1\"";
    if ($vars['category'] == -1) {
        $output .= ' selected';
    }
