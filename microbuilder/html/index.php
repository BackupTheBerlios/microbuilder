<?php
// File: $Id: index.php,v 1.1 2004/03/01 10:08:57 mbertier Exp $ $Name:  $
// ----------------------------------------------------------------------
...
if ($modinfo['type'] == 2)
{
	...
	/* do we really need this here [larsneo]
...
*/
        ...
        $output->StartPage();
        $output->SetInputMode(_PNH_VERBATIMINPUT);
        $output->Text('Function <I>'.$func.'</I> in module <I>' . $module .'</I> return TRUE!');
        $output->SetInputMode(_PNH_PARSEINPUT);
        $output->EndPage();
        $output->PrintPage();
        */
