<?php
// File: $Id: global.php,v 1.1 2004/03/01 10:09:13 mbertier Exp $
// ----------------------------------------------------------------------
...
define('_AUTOLINKSNOAUTH','Not authorized to administer autolinks');
...
define('_BLOCKSNOAUTH','Not authorized to carry out operation on blocks');
...
define('_EMAILREGISTERED','Try again, this e-mail address is already registered');
define('_ENV','ENV');
...
define('_ERRORNODESCRIPTION','Try again, you need to include a DESCRIPTION for your link!');
define('_ERRORNOTITLE','Try again, you need to type a title for your link!');
define('_ERRORNOURL','Try again, you need to type a URL for your link!');
define('_ERRORTHECATEGORY','ERROR: The category');
define('_ERRORURLEXIST','Try again, this link is already listed in the database!');
...
define('_NICKNOSPACES','Try again you cannot use spaces in the username');
define('_NICKTAKEN','Try again this username is already taken');
define('_NO','No');
define('_NOANONCOMMENTS','Comments not allowed for guests, please <a href=\'user.php\'>register</a>');
...
define('_ON','on');
define('_ONEPERDAY','We allow one vote per day');
...
define('_PERMISSIONSNOAUTH','You are not authorized to carry out this operation');
...
define('_PROMOTE04','If you cheat on this, we\'ll remove your link. Having said this, here is what the current remote rating form looks like.');
...
define('_RATENOTE5ERROR','No rating selected - no vote counted');
...
define('_RATINGSNOAUTH','Not authorized to access Ratings module');
...
define('_TEMPLATENOAUTH','Not authorized to access Template module');
...
define('_UNREGISTEREDUSERS','Guests');
define('_UP','Up');
define('_UPDATEFAILED','Attempted update of block failed');
define('_UREALEMAIL','Current e-mail');
...
define('_VERSION_WARNING','NOTE: Official PostNuke Distributions are ONLY available from <a href="http://download.postnuke.com/" target="_blank">PostNuke.com</a>.<br>For quality assurance, please ensure you are installing an Official Distribution.');
define('_VISIT','Visit');
define('_VOTE','Vote');
